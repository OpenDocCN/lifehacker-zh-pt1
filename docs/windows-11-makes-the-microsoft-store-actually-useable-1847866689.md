...
微软继续让商店的搜索过程对用户来说更容易，这包括创建新的结果页面，将最相关和最想要的内容放在第一位。

此外，新的过滤器允许用户根据应用程序年龄等级或类别来定制他们的搜索。现在，您可以使用 **All Types** 下拉菜单来过滤应用销售、付费应用或免费应用。你也可以切换这些应用程序的**部门**和**所有年龄段**来更彻底地搜索商店。
...
新的操作系统允许用户点击网页上的“从微软获得”徽章，就可以访问迷你版的微软商店。例如，在有应用程序徽章的网站上，你可以用这个迷你弹出版本的微软商店在线下载应用程序，以调解安装。
