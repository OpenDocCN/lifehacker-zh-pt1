...
*   100%硅酮嵌缝膏(透明或浅色，取决于您的淋浴设计和喜好)
*   填缝枪

这个项目非常简单:

1.  将架子举到你的灌浆线，并标记出标签的位置。
2.  使用灌浆锯在插片插入的地方切割灌浆。因为这些切口很小，所以用手动灌浆锯很容易做到。
3.  用胶带粘住瓷砖，并用硅酮嵌缝膏填补切割的缝隙。
4.  将架子安装到位。拉环会牢牢抓住它。
5.  用填缝剂填充顶部和底部的缝隙。如果架子有点下垂，就加一个支架。
6.  平滑填缝并去除胶带。

这就对了，一旦硅胶固化，你就大功告成了，你的搁板就可以使用了。
...
1.  首先，用肥皂泡沫去除剂清洁你将要放置搁板的墙壁。在这里好好干。如果你的瓷砖上有浮渣或任何其他涂层，你会损害你的债券，你的架子会掉下来，导致脚趾磕破，眼泪和羞辱。
2.  在搁板背面的两侧贴上一条安装胶带，每端大约短一英寸。暂时将背衬留在外侧。
3.  试装搁板。你要确保它紧贴墙壁。如果它不是很方，你可以根据需要增加额外的胶带层来填补它。用水平仪标出架子要放在哪里。
4.  在架子背面的边缘添加粗线条的嵌缝材料。然后去掉胶带的背面，使用之前做的标记，将搁板推到墙上。胶带会被卡住，嵌缝材料会被挤出。如有必要，添加一个支架，以保持搁板水平，直到它竖立起来。清理和平滑你的嵌缝，然后等待它成立。

一旦你的嵌缝材料凝固，你就完成了——只有极端暴力的行为才能移除那个架子。