...
*   一台 [缝纫机](https://www.joann.com/singer-3223gy-sewing-machine-grey/15519416.html?gclid=CjwKCAjwwL6aBhBlEiwADycBIBqv5zBGZeN8OyLTn3L9TdNRChLSwKQzk3FrLVYOlKEL_h33EZpJuBoCVk8QAvD_BwE)
*   一 [厨房秤](https://www.target.com/p/insten-digital-food-kitchen-scale-in-grams-ounces-1g-0-1oz-precise-upto-11lb-5000g-capacity-silver/-/A-78772079?ref=tgt_adv_XS000000&AFID=google_pla_df_free_online&CPNG=storefront&adgroup=70-5)
*   [F 柔性织物卷尺](https://www.fredmeyer.com/p/singer-heavy-duty-vinyl-tape-measure/0007569100258?fulfillment=PICKUP&storecode=70100135&&cid=shp_adw_shopl_.fred+meyer_g_lia_shop_eng_evgn_ship_craft+%26+hobby&gclid=CjwKCAjwwL6aBhBlEiwADycBIEBPyVHrAX8b2sQ6G0Ie4CybZiYNAHV72_p5K_WvHYDuIZbDrV7hexoCkikQAvD_BwE&gclsrc=aw.ds)
*   剪刀
*   一个 [洗出布料标记](https://www.joann.com/dritz-quilting-disappearing-ink-marking-pen/4791885.html?utm_source=google&utm_medium=cpc&gclid=CjwKCAjwwL6aBhBlEiwADycBIGn-5R412T4QMBgaxzyQNcJt0Il1iAHVfjEZGx37XGfEWclm8rqEWRoC3ZwQAvD_BwE)
*   T1】PinsT4】
...
首先将两块布料的三面缝合在一起，使它们的正面相对。你可以用双线缝合这条缝，因为它会成为你毯子的边缘。将布料正面朝外，用熨斗将边缘熨平。然后在离第一条缝边半英寸的地方缝上三条边的外侧，为你的毯子创建一个边界。现在，你应该有一个有三个完成面和一个开放面的袋子。

## 标出你的方格，并把它们缝起来

接下来，用你的织物记号笔沿着敞开的边缘每隔四英寸做一个标记，每隔四英寸做一条线，然后上下移动。你可以画一条虚线，或者用任何能让你缝出直线的方法。然后，从开口边缘的对面开始，每隔四英寸将两块裁片缝合在一起，朝着开口边缘缝合。一旦每一行都缝好了，你就会得到又长又瘦的口袋。

## 填充并缝合您的方块

在每个长口袋里放大约一盎司的填充珠，沿着垂直于口袋的线别住。沿着第一条水平线缝合。重复这个过程，朝着打开的那一行前进，直到到达最后一行方块。在这一点上，你应该有一排排的方块，除了最后一排，每一排都有填充珠。

## 完成你的毯子

将一盎司填充珠放入最后一排口袋中，将织物边缘翻过来并压平。然后，从边缘缝半英寸，缝合最后一排方格，完成毯子的边缘。现在你应该有一个完整的毯子。