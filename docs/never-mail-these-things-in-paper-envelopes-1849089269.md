...
人们有时会认为物品是偷来的，如果是贵重物品，比如珠宝，这就说得通了。但是许多丢失的物品是硬币、没有标签的钥匙和糖果。他们不是小偷的目标。罪魁祸首是一个机器人。

## 为什么小物件不能通过邮件分拣机

[这段视频](https://www.youtube.com/watch?v=c4nj7IH_fik) 一个邮件扫描机显示的问题。信封沿着一组传送带呼啸而过，当它们绕过机器时会急转弯。任何不能转弯的东西都会从信封上撕下来，掉到机器的底部，或者有时会卡住作品(并在这个过程中弄皱接下来的几个字母)。

 [https://lifehacker.com/embed/inset/iframe?id=youtube-video-c4nj7IH_fik&start=0](https://lifehacker.com/embed/inset/iframe?id=youtube-video-c4nj7IH_fik&start=0)

<figcaption class="sc-1ptbguh-0 hxeMec caption">DBCS in Action - THIS is Why You Can’t Mail a Pen in a 1st Class Letter Envelope</figcaption> 

## 哪些东西不能放在纸信封里邮寄

根据美国邮政局的规定，纸质信封中不允许包含以下物品:
...
在几所大学邮件收发室的网站上找到的一个列表(比如 [这个](https://www.callutheran.edu/offices/mail-center/services-guide/mail-standards.html) )说美国邮政总局不允许在邮件中使用回形针或别针。我在任何美国邮政管理局的官方出版物中都找不到这条规则，但我承认，如果你想安全起见，不邮寄松散的别针，用订书钉代替回形针似乎是个好主意。

## **为什么写“手工处理”不能保证小邮件的安全**
