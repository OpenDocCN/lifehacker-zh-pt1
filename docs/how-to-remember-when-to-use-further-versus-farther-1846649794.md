...
> 原文:[https://life hacker . com/how-to-remember-when-use-further-vs . further-1846649794](https://lifehacker.com/how-to-remember-when-to-use-further-versus-farther-1846649794)
...
> 区分 [*更远*](https://www.merriam-webster.com/dictionary/further)T5】和 [*更远*](https://www.merriam-webster.com/dictionary/farther) 的问题是复杂的，因为这些词中的每一个都可以是副词、形容词或动词，并且在这些词类中的一些词类中具有多重含义。在某些情况下，你最好使用其中一个，在其他情况下，有一定程度的回旋余地，而在其他情况下，使用哪一个并不重要。欢迎来到英语。

但是我们不需要在这里的杂草中迷失方向。这两个词都用来表示某事物的更大程度。要选择正确的，在大多数情况下，区别很简单:当你指物理距离时，用*更远*，用*更远*表示比喻距离。

你今天比昨天跑得更远。你父母住得比你姐姐离你远。路被堵住了，所以你不能再往前走了。不过，你在寻求职业发展。我们在这里进一步说明这一点。我们需要进一步讨论这个吗？

如果你需要一个窍门来记住哪个是哪个，记住*更远*指的是某物有多远*。进一步指其他一切。*