# 用 GameOn 录制并分享您最好的手机游戏片段

> 原文：<https://lifehacker.com/record-and-share-your-best-mobile-gaming-clips-with-gam-1846407726>
...
您需要一个游戏帐户才能上传剪辑。你可以在应用中创建一个新的，或者链接到现有的亚马逊账户(奇怪的是，该应用没有集成到 Twitch，亚马逊也拥有 Twitch)。

### 如何使用 GameOn 应用程序录制、编辑和分享片段

1.  在 GameOn 应用程序中，点击屏幕底部的 **"+"** 按钮，准备新的录像。
2.  点击下一个屏幕顶部的滑块，选择您的捕获方法。**《经典》**将录制长达 5 分钟的游戏玩法。这有利于在游戏发生时捕捉游戏性。**【回忆】**模式会在您按下录制按钮时保存游戏的最后时刻。如果您想要确保在事件发生后保存素材，请打开此模式。
3.  设置录像的长度。这个应用程序可以让你每段视频节省 30 秒、1 分钟、2 分钟或 5 分钟。
4.  点击红色按钮开始录音或回忆。

录制将在指定时间后自动结束，但您也可以手动停止录制。有三种方法可以停止正在进行的录制:

*   轻按屏幕顶部的红色录制图标
*   点击 GameOn 应用程序中的“停止录制”按钮
*   或者打开 iOS 操作中心并轻按红色录音按钮

捕捉到游戏片段后，您可以在 GameOn 应用程序中编辑片段。这款应用可以让你修剪镜头，添加音频评论，甚至使用手机的自拍相机插入介绍和反应。一旦您的剪辑准备好发布，您可以将其上传到 GameOn 供其他用户观看，或者将其存储为可共享的链接，发送给朋友。